...
describe('most likes', () => {
    ...
    test('in a list with one object is the author and likes of that object', () => {
        assert.deepStrictEqual(listHelper.mostLikes(listWithOneBlog), { author: 'Blog Person', likes: 10 })
    })
    test('in a long is the author with the most total likes', () => {
        assert.deepStrictEqual(listHelper.mostLikes(listWithLotsOfBlogs), { author: 'Edsger W. Dijkstra', likes: 17 })
    })
})
